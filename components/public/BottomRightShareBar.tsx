...
const shareActions: ShareActionItem[] = [
  { id: 'link', icon: LinkIcon, label: 'Copy link', iconClassName: 'w-[12.18px] h-[12.18px] text-black' },
  { id: 'image', icon: PhotoIcon, label: 'Share image', iconClassName: 'w-3.5 h-3.5 text-black' },
  { id: 'comment', icon: ChatBubbleLeftEllipsisIcon, label: 'Comment', iconClassName: 'w-3.5 h-3.5 text-black' },
  { id: 'website', icon: GlobeAltIcon, label: 'Visit website', iconClassName: 'w-3.5 h-3.5 text-black' },
  { id: 'files', icon: WindowFilesIcon, label: 'More options', iconClassName: 'w-3.5 h-3.5 text-black' },
];
        ...
        {shareActions.map(action => (
          ...
          >
            <div className="w-[24px] h-[24px] bg-white rounded-[7px] shadow-[0px_0.6px_2px_rgba(0,0,0,0.06)] border border-[rgba(0,0,0,0.12)] flex items-center justify-center overflow-hidden relative">
              ...
              <action.icon className={action.iconClassName || 'w-3.5 h-3.5 text-gray-700'} />
...
export default BottomRightShareBar;
