...
const AuthForm: React.FC = () => {
  ...
  const validate = useCallback(() => {
    ...
    if (
      ...
      fields.password.length < PASSWORD_MIN
    )
  ...
  return (
    <div className="max-w-md mx-auto py-8">
      ...
      >
            ...
            >
              {showPassword ? (
                <svg width="20" height="20" fill="none" viewBox="0 0 24 24">
                  <path
                    d="M3 3l18 18M1 1l22 22"
                    stroke="currentColor"
                    strokeWidth="2"
                  />
                  <path
                    d="M12 4C7 4 2.73 7.11 1 12c.62 1.67 1.62 3.21 2.9 4.5l2.12-2.12A7.96 7.96 0 0112 6a7.96 7.96 0 015.98 2.38l2.12-2.12C21.37 7.11 17 4 12 4z"
                    stroke="currentColor"
                    strokeWidth="2"
                  />
                </svg>
        ...
        {errorMsg && (
          <div
            className="text-red-600 bg-red-50 border border-red-200 rounded p-2 text-sm flex items-center"
            role="alert"
        ...
        {successMsg && (
          <div
            className="text-green-700 bg-green-50 border border-green-200 rounded p-2 text-sm flex items-center"
            role="status"
        ...
        <div className="flex justify-between mt-2 text-sm">
          ...
          {mode !== 'reset' && (
            <Link
              ...
              className="text-orange-600 hover:underline focus:underline"
              tabIndex={0}
            >
              Забыли пароль?
            </Link>
